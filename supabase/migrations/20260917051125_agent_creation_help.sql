...
Open Settings → AI and add and test your own provider connection. Then open Agent. Core Roleway tracking still works without AI; your provider may charge separately for API use.
