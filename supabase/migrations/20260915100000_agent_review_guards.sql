-- Preserve the state read before generation; legacy Next Action proposals expire safely.
alter table public.agent_proposals add column expected_next_action jsonb;
